...
var dataCenter = {
    ...
    getRefreshRuleFromServerByAreaLevel: function getRefreshRuleFromServerByAreaLevel(givenLevel) {
    ...
    getFishConfigByFishId: function getFishConfigByFishId(givenId) {
